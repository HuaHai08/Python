...
""", "d"),
    Question("""
Word Cup lần đầu tiên được tổ chức ở nước nào?
a. Uruguay
b. Brazil
c. Argentina
d. Chile
...
a. Toán hạng đều là TRUE.
b. Cả hai toán hàng đều là FALSE.
c. Một trong hai toán hạng là TRUE.
d. Cả hai toán hạng đầu tiên là TRUE.
""", "d"), 
    Question("""
Quy tắc 5K về phòng chống dịch KHÔNG có nguyên tắc nào dưới đây?
a. Khẩu trang.
b. Khử khuẩn.
c. Khô ráo.
d. Không tụ tập.
...
""", "b"),
    Question("""
Kí hiệu nào dùng để xác định các khối lệnh?
a. Dấu ngoặc đơn ().
b. Dấu ngoặc kép {}.
c. Thụt lề.
d. Dấu ngoặc vuông [].
""", "c"),
    Question("""
Đâu là quy tắc Đúng khi đặt tên biến trên Python?
a. Tên biến có thể bắt đầu bằng gạch dưới "_".
b. Có thể sử dụng keyword làm tên biến.
c. Tên biến có thể bắt đầu bằng một chữ số.
d. Tên biến có thể bắt đầu bằng !, @, $, #,...
""", "a"),
    Question("""
Thủ tướng ban hành chỉ thị 16 giãn cách xã hội bao nhiêu tỉnh, thành ở phía Nam?
a. 18 tỉnh
b. 20 tỉnh
c. 19 tỉnh
d. 17 tỉnh
...
def setup_turtle():
    ...
    screen.bgpic('background_hospital.gif')
...
# Lệnh kết thúc
def end_screen():
    turtle.write('Score: {}'.format(state.score))
    turtle.mainloop()
