...
def setup_turtle():
    ...
    screen.bgpic("file:///C:/Users/MYLAP.VN/Desktop/Workspace/python/finnal projects CS101/CS101background_hospital.jpg")
...
def end_screen():
    ...
    turtle.write('Score: {}'.format(state.score), font=style)
    turtle.mainloop()
    time.sleep()
